/*
 * The Header now includes a link to the "My Orders" page in the user menu.
 */
            ...
            <div className="container mx-auto px-4 py-3 flex justify-between items-center">
                ...
                <div className="flex items-center space-x-4">
                    {userData.user ? (
                        ...
                        <>
                            <button className="text-gray-600 hover:text-brand-green font-medium hidden sm:block">हिन्दी</button>
